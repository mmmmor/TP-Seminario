...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex flex-col">
      ...
      {/* Barra superior — igual al Header del landing */}
        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="bg-white border border-neutral-200">
            <form onSubmit={handleSubmit} className="p-8 space-y-6">
              ...
              >
                {loading ? 'Ingresando...' : <><span>Ingresar</span><span className="opacity-60">→</span></>}
              </button>
            ...
            <div className="px-8 py-4 border-t border-neutral-200 flex items-center justify-between">
              <span className="text-[11px] font-mono text-neutral-400">¿No tenés cuenta?</span>
              <Link
                to="/registro"
